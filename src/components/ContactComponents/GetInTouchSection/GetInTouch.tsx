...
export default function GetInTouch() {
  return (
    <section className="relative w-full bg-[#0D0D0D] py-24 overflow-hidden">
      <div className="pointer-events-none absolute top-[-200px] left-1/2 -translate-x-1/2 w-[420px] h-[420px] sm:w-[600px] sm:h-[600px] lg:w-[800px] lg:h-[800px]bg-[#BFA34A]/10 blur-[140px] rounded-full" />
