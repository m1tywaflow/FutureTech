...
const BlogTabs = () => {
  ...
  return (
    <div className="w-full max-w-7xl mx-auto py-8 text-white">
      <div className="flex justify-center gap-4 overflow-x-auto scrollbar-hide border-b border-neutral-800 pb-4 mb-6">
        {categories.map((category) => (
          <button
            key={category}
            onClick={() => setActiveTab(category)}
            className={`px-6 py-2 rounded-md text-sm transition-all border ${
              activeTab === category
